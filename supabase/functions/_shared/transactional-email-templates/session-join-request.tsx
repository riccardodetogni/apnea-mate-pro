...
const SessionJoinRequestEmail = ({ recipientName, requesterName, sessionTitle, sessionId, spotName, sessionDate }: Props) => (
  <Html lang="it" dir="ltr">
    <Head />
    <Preview>Nuova richiesta di partecipazione</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Button style={button} href={`${SITE_URL}/sessions/${sessionId}`}>Gestisci richiesta</Button>
...
export const template = {
  component: SessionJoinRequestEmail,
  subject: (d: any) => `Nuova richiesta per "${d.sessionTitle || "la tua sessione"}"`,
  displayName: "Session join request",
  previewData: { recipientName: "Marco", requesterName: "Luca", sessionTitle: "Apnea profonda Y-40", sessionId: "abc", spotName: "Y-40", sessionDate: "sabato 1 giugno, 10:00" },

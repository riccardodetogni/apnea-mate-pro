...
interface Props { recipientName?: string; courseTitle?: string; courseId?: string; courseDate?: string; courseLocation?: string }

const CourseRequestApprovedEmail = ({ recipientName, courseTitle, courseId, courseDate, courseLocation }: Props) => (
  <Html lang="it" dir="ltr">
    <Head />
    <Preview>Iscrizione al corso approvata!</Preview>
    <Body style={main}>
      <Container style={container}>
        <Img src={LOGO} alt="Apnea Mate" width="180" style={logo} />
        <Heading style={h1}>Iscrizione approvata! 🎉</Heading>
        <Text style={text}>Ciao {recipientName || "freediver"}!</Text>
        <Text style={text}>La tua iscrizione al corso è stata <strong>approvata</strong>:</Text>
        ...
        <Text style={text}>Ci vediamo in acqua!</Text>
        <Button style={button} href={`${SITE_URL}/courses/${courseId}`}>Vedi corso</Button>
...
export const template = {
  component: CourseRequestApprovedEmail,
  subject: (d: any) => `Sei iscritto a "${d.courseTitle || "il corso"}"! 🎉`,
  displayName: "Course request approved",
  previewData: { recipientName: "Luca", courseTitle: "Corso Apnea Outdoor Liv. 1", courseId: "abc", courseDate: "15-17 giugno 2026", courseLocation: "Y-40" },

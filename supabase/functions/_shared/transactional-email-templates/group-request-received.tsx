...
const GroupRequestReceivedEmail = ({ recipientName, requesterName, groupName, groupId, groupLocation }: Props) => (
  <Html lang="it" dir="ltr">
    <Head />
    <Preview>Nuova richiesta di adesione</Preview>
    <Body style={main}>
...
export const template = {
  component: GroupRequestReceivedEmail,
  subject: (d: any) => `Nuova richiesta di adesione a "${d.groupName || "il tuo gruppo"}"`,
  displayName: "Group request received",
  previewData: { recipientName: "Marco", requesterName: "Luca", groupName: "Apnea Milano", groupId: "abc", groupLocation: "Milano" },

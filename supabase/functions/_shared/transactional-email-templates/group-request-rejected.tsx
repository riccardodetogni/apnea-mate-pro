...
const GroupRequestRejectedEmail = ({ recipientName, groupName, groupLocation }: Props) => (
  <Html lang="it" dir="ltr">
    <Head />
    <Preview>Richiesta gruppo non approvata</Preview>
    <Body style={main}>
...
export const template = {
  component: GroupRequestRejectedEmail,
  subject: (d: any) => `Richiesta per "${d.groupName || "il gruppo"}" non approvata`,
  displayName: "Group request rejected",
  previewData: { recipientName: "Luca", groupName: "Apnea Milano", groupLocation: "Milano" },

...
const SessionRequestRejectedEmail = ({ recipientName, sessionTitle, spotName, sessionDate }: Props) => (
  <Html lang="it" dir="ltr">
    <Head />
    <Preview>Richiesta non approvata</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Button style={button} href={`${SITE_URL}/community`}>Esplora sessioni</Button>
...
export const template = {
  component: SessionRequestRejectedEmail,
  subject: (d: any) => `Richiesta non approvata per "${d.sessionTitle || "la sessione"}"`,
  displayName: "Session request rejected",
  previewData: { recipientName: "Luca", sessionTitle: "Apnea profonda Y-40", spotName: "Y-40", sessionDate: "sabato 1 giugno, 10:00" },

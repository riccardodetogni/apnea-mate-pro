...
// SENDER_DOMAIN must match the verified delegated subdomain where Lovable
// manages DKIM/SPF (notify.apneamate.com), not the root domain. Mailgun looks
// up the sending domain by this exact FQDN.
export const SENDER_DOMAIN = env("EMAIL_SENDER_DOMAIN", "notify.apneamate.com");

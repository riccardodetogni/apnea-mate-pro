...
const translations = {
  ...
  en: {
    ...
    privacyImportantDesc: "Sign-up only requires accepting the Privacy Policy. Marketing consent is optional and can be withdrawn at any time from your profile settings.",

...
const translations = {
  it: {
    ...
    privacyImportantDesc: "L'iscrizione richiede solo l'accettazione dell'Informativa Privacy. Il consenso al marketing è facoltativo e revocabile in qualsiasi momento dalle impostazioni del profilo.",

...
const translations = {
  it: {
    ...
    privacyConsentIntro: "Acconsento al trattamento dei miei dati personali da parte di Apnea Mate S.r.l. per le seguenti finalità:",
    ...
    privacyCheckboxD: "Finalità commerciali, condividendo detti dati con eventuali partner di Apnea Mate S.r.l. al fine di offrire, a titolo esemplificativo, promozioni legate all'apnea e/o alle relative attrezzature.",
  ...
  en: {
    ...
    privacyCheckboxA_part2: ".",
    privacyConsentIntro: "I consent to the processing of my personal data by Apnea Mate S.r.l. for the following purposes:",
    ...
    privacyCheckboxD: "Commercial purposes, including sharing said data with any Apnea Mate S.r.l. partners in order to offer, by way of example, promotions related to freediving and/or related equipment.",
